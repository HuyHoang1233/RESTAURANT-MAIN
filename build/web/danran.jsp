                ...
                <div class="container mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div class="z-10">
                        ...
                        <p class="text-lg text-text-sub mb-10 max-w-lg leading-relaxed">
                            Tối ưu quy trình order, kiểm soát nguyên liệu và tăng doanh thu lên đến 30% với giải
                            pháp công nghệ tin cậy.
                        </p>
            ...
            <section id="features" class="py-24 bg-white">
                <div class="container mx-auto px-4">
                    ...
                    <div class="text-center max-w-2xl mx-auto mb-16">
                        <h2 class="text-4xl font-black text-secondary mb-4 tracking-tight">
                            Tính năng vượt trội cho F&B</h2>
                        <p class="text-text-sub text-lg">Mọi thứ bạn cần để vận hành trơn tru từ phòng bàn, bếp
                            bar đến báo cáo quản trị.</p>
                    </div>
                    ...
                    <div class="grid md:grid-cols-3 gap-8">
                        ...
                        <div
                            ...
                            <p class="text-text-sub leading-relaxed">Khách hàng tự quét mã gọi món, đơn hàng
                                chuyển thẳng xuống bếp. Giảm 90% sai sót và tiết kiệm chi phí nhân sự phục vụ.
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-text-sub leading-relaxed">Màn hình hiển thị món trực quan, sắp xếp
                                khoa học theo thời gian thực. Giúp đầu bếp chế biến đúng thứ tự, không sót món.
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-text-sub leading-relaxed">Nắm bắt doanh thu, lợi nhuận, tồn kho mọi
                                lúc mọi nơi trên điện thoại. Ra quyết định kinh doanh chính xác dựa trên số
                                liệu.
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-12 items-center">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-gray-400 mb-8 leading-relaxed">Bạn gặp khó khăn gì trong quản lý?
                                    Hãy hỏi AI Assistant của Danran để nhận giải pháp tối ưu ngay lập tức.</p>
            ...
            function generateLocalResponse(businessType, challenge) {
                ...
                switch (businessType) {
                    ...
                    case 'Bar/Pub':
                        ...
                        break;
                    default:
                        response = 'Cảm ơn bạn đã chia sẻ. Danran có thể giúp bạn giải quyết vấn đề "' + challenge + '" với các tính năng Order QR, KDS và Báo cáo Real-time.';
                }
