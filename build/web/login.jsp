                        ...
                        <div class="max-w-[480px] w-full mx-auto space-y-10">
                                ...
                                <% if (request.getAttribute("errorMessage") !=null) { %>
                                    ...
                                    <% } %>
                                        ...
                                        <% if (request.getAttribute("successMessage") !=null) { %>
                                            <div
                                                class="p-4 bg-green-50 border border-green-100 text-green-600 rounded-2xl text-sm font-bold flex items-center gap-2">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <span
                                                                class="text-text-main font-bold flex items-center gap-1">
                                                                +84 <span
                            ...
                            <div class="space-y-6">
                                <div class="relative flex items-center py-2">
                                    ...
                                    <span
                                        class="flex-shrink-0 mx-4 text-text-secondary text-sm font-bold uppercase tracking-widest opacity-60">
                                        Hoặc đăng nhập với
                                    </span>
                                    <div class="flex-grow border-t border-border"></div>
                                </div>
