<%@ page pageEncoding="UTF-8" contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <head>
        ...
        <title>Dashboard - Bếp Cloud</title>
    ...
    <body class="bg-gray-50 font-sans">
        ...
        <!-- Kiểm tra đăng nhập -->
        <% if (session.getAttribute("userPhone")==null) { response.sendRedirect("login.jsp"); return; }
            com.bepcloud.model.User currentUser=(com.bepcloud.model.User) session.getAttribute("user"); %>
            ...
            <div class="flex h-screen overflow-hidden">
                ...
                <aside class="w-64 bg-secondary text-white flex flex-col">
                    <div class="p-6 flex items-center gap-2">
                        ...
                        <span class="text-xl font-bold">Bếp Cloud</span>
                    </div>
