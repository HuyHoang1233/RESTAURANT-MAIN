...
public class CartServlet extends HttpServlet {
    ...
    static {
        UPSELL_ITEMS.add(new UpsellItem("u1", "Bánh Flan", 15000,
        ...
        UPSELL_ITEMS.add(new UpsellItem("u2", "Khăn Giấy Ướt", 5000,
        ...
        UPSELL_ITEMS.add(new UpsellItem("u3", "Bánh Quy Bơ", 12000,
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cart == null) {
            ...
            cart.add(new CartItem("3", "Bánh Phô Mai Dâu", "1 cái", 45000, 1,
