<%@ page pageEncoding="UTF-8" contentType="text/html;charset=UTF-8" language="java" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <title>Đặt bàn thành công - Bếp Cloud</title>
            ...
            <main class="flex-1 flex items-center justify-center p-4">
                <div class="max-w-md w-full">
                    ...
                    <div class="text-center mb-8">
                        <div
                            class="inline-flex items-center justify-center size-24 bg-green-100 rounded-full mb-4 animate-checkmark">
                            <span
                                class="material-symbols-outlined filled text-green-500 text-[60px]">check_circle</span>
                        </div>
                    ...
                    <div class="bg-white rounded-3xl shadow-xl overflow-hidden animate-fade-in-up delay-2">
                        ...
                        <div class="p-6 space-y-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="font-semibold">Bếp Cloud - ${branch eq 'quan1' ? 'Quận 1' : 'Quận 3'}</p>
                                </div>
                            </div>
                        ...
                        <div class="px-6 pb-6">
                            <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-700">
                                ...
                                Vui lòng đến đúng giờ. Bàn sẽ được giữ trong <strong>15 phút</strong> kể từ thời gian
                                hẹn.
                            </div>
                        </div>
                    </div>
