                    ...
                    <div class="flex w-full min-h-screen">
                        ...
                        <main class="flex-1 flex flex-col min-w-0 p-6 md:p-8 lg:p-12 gap-10 overflow-y-auto">
                            ...
                            <div
                                ...
                                <div
                                    class="absolute inset-0 bg-gradient-to-r from-secondary/90 via-secondary/50 to-transparent z-10">
                                </div>
                                <div class="flex min-h-[400px] flex-col gap-6 bg-cover bg-center bg-no-repeat items-start justify-center px-10 md:px-20 py-12 relative z-20"
                                    ...
                                    <div
                                        class="flex items-center gap-2 bg-primary text-white px-5 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.25em] shadow-xl shadow-primary/40">
                                    ...
                                    <div class="flex flex-col gap-4 max-w-2xl">
                                        <h1
                                            class="text-white text-5xl md:text-6xl font-black leading-tight tracking-tighter drop-shadow-2xl">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <span
                                                class="material-symbols-outlined text-4xl filled">workspace_premium</span>
                                        </div>
                                        <div>
                            ...
                            <!-- Chef/Story Section -->
                            <div
                                class="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-sm border border-gray-50 flex flex-col md:flex-row gap-10 items-center">
                                <div
                                ...
                                <div class="w-full md:w-1/2 flex flex-col gap-6">
                                    <div
                                        class="flex items-center gap-2 text-primary font-black uppercase text-xs tracking-widest">
                                        <span class="h-0.5 w-10 bg-primary"></span>
                                        Bếp Trưởng
                                    </div>
                                    <h3 class="text-4xl font-black text-secondary italic">"Nấu ăn là nghệ thuật sẻ
                                        chiayêu thương."</h3>
                        ...
                        <aside
                            ...
                            <div
                                class="p-6 bg-blue-50 rounded-[2rem] border border-blue-100 flex flex-col gap-3 text-center">
