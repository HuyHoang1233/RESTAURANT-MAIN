            ...
            <div class="w-full lg:w-1/2 flex flex-col items-center justify-center bg-white relative overflow-y-auto">
                ...
                <div class="w-full max-w-[460px] px-6 py-10 animate-fade-in-up">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <a href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile&redirect_uri=http://localhost:8081/Restaurant_Management/login-google&response_type=code&client_id=564583690749-82fah1b28gfo5v8mi91qs309uc9a2n5n.apps.googleusercontent.com&approval_prompt=force"
                        ...
                        <a href="https://www.facebook.com/dialog/oauth?client_id=564583690749-82fah1b28gfo5v8mi91qs309uc9a2n5n.apps.googleusercontent.com&redirect_uri=http://localhost:8081/Restaurant_Management/login-facebook&scope=email,public_profile"
                           class="flex items-center justify-center gap-2 py-3 px-4 border border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 group">
