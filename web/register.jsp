        ...
        <main class="flex w-full h-screen overflow-hidden">
            ...
            <section
                ...
                <div class="absolute bottom-10 left-10 right-10 p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md z-20 hidden xl:block">
                    <p class="text-white/70 text-sm font-medium italic">"Gia nhập cộng đồng 2000+ chủ nhà hàng hiện đại ngay hôm nay."</p>
                </div>
            </section>
                                ...
                                <% if (request.getAttribute("errorMessage") !=null) { %>
                                    ...
                                    <% } %>
                                        ...
                                        <div class="space-y-3 px-4">
                                            <label class="text-text-main text-sm font-bold block uppercase tracking-wider opacity-70">
                                                Bạn đăng ký với vai trò là:
                                            </label>
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                <!-- Admin Option -->
                                                <label class="relative flex items-center p-4 rounded-2xl border border-border bg-white cursor-pointer hover:border-primary/50 transition-all has-[:checked]:border-primary has-[:checked]:bg-primary/5 group">
                                                    <input type="radio" name="roleId" value="1" class="sr-only" checked />
                                                    <div class="flex flex-col">
                                                        <span class="text-base font-black text-text-main group-has-[:checked]:text-primary">
                                                            Chủ quán</span>
                                                        <span class="text-[10px] text-text-secondary opacity-60">
                                                            Admin - Quản lý nhà hàng</span>
                                                    </div>
                                                    <span class="material-symbols-outlined ml-auto text-primary opacity-0 group-has-[:checked]:opacity-100">check_circle</span>
                                                </label>
                                                <!-- Customer Option -->
                                                <label class="relative flex items-center p-4 rounded-2xl border border-border bg-white cursor-pointer hover:border-primary/50 transition-all has-[:checked]:border-primary has-[:checked]:bg-primary/5 group">
                                                    ...
                                                    <div class="flex flex-col">
                                                        <span class="text-base font-black text-text-main group-has-[:checked]:text-primary">
                                                            Khách hàng</span>
                                                        <span class="text-[10px] text-text-secondary opacity-60">
                                                            Customer - Trải nghiệm dịch vụ</span>
                                                    </div>
                                                    <span class="material-symbols-outlined ml-auto text-primary opacity-0 group-has-[:checked]:opacity-100">check_circle</span>
                                                </label>
                                            </div>
                                        ...
                                        <div class="flex items-start gap-3 px-4">
                                          ...
                                          class="mt-1 w-4 h-4 rounded border-gray-300 text-primary focus:ring-primary" />
                                            <label for="terms" class="text-sm text-text-secondary">
                                                Tôi đồng ý với 
                                                <a href="#" class="text-primary font-bold hover:underline">Điều khoản dịch vụ</a> và
                                                <a href="#" class="text-primary font-bold hover:underline">Chính sách bảo mật</a> của Danran.
                                            </label>
                                        </div>
