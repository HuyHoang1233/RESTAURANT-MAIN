        ...
        <%@ page import="com.bepcloud.model.User" %>
            <% User currentUser=(User) session.getAttribute("user"); %>
                ...
                <head>
                    ...
                    <title>Thực đơn & Đặt món - Bếp Cloud</title>
                    <meta name="description"
                        content="Khám phá thực đơn đa dạng với hơn 100 món ăn và đồ uống. Đặt món trực tuyến, giao hàng tận nơi.">
                    <meta name="keywords" content="Thực đơn, Đặt đồ ăn, Bếp Cloud, Food Delivery">
                                ...
                                <div class="flex items-center justify-between h-16 lg:h-20">
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <a href="${pageContext.request.contextPath}/home"
                                            ...
                                            <span class="text-xl font-black tracking-tight">Bếp Cloud</span>
                                        </a>
                                    </div>
                        ...
                        <main class="flex-1 pt-28 lg:pt-24">
                            <div class="max-w-7xl mx-auto flex">
                                ...
                                <aside
                                    ...
                                    <h3 class="text-[10px] font-black uppercase tracking-[0.2em] text-gray-300 mb-6">
                                        Danh mục</h3>
                                ...
                                <div class="flex-1 px-4 lg:px-8 pb-32 lg:pb-20">
                                    ...
                                    <section id="cat-combo" class="scroll-mt-nav mb-10">
                                        ...
                                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 mt-4">
                                            <!-- Menu Item Card (Desktop) / Row (Mobile) -->
                                            <div
                                                class="menu-item group bg-white rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-sm hover:shadow-xl border border-gray-50 transition-all duration-300 flex lg:flex-col gap-4">
                                                <!-- Image -->
                                                <div class="relative shrink-0 w-24 h-24 lg:w-full lg:h-40 rounded-xl lg:rounded-2xl bg-cover bg-center overflow-hidden"
                                                    style="background-image: url('https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&h=300&fit=crop');">
                                                    <span
                                                        class="absolute top-2 left-2 bg-red-500 text-white text-[9px] font-black px-2 py-1 rounded-full uppercase tracking-wider shadow-lg">Best
                                                        Seller</span>
                                                </div>
                                                <!-- Info -->
                                                <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                                    <div>
                                                        <h4
                                                            ...
                                                            Combo Burger Đôi</h4>
                                                        <p class="text-xs lg:text-sm text-gray-400 line-clamp-2 mt-1">2
                                                            Burger bò Úc + Khoai tây chiên + 2 Pepsi. Tiết kiệm 50k!</p>
                                                    </div>
                                                    <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                        <div class="flex flex-col">
                                                            <span
                                                                class="text-lg lg:text-xl font-black text-primary">199,000đ</span>
                                                            <span
                                                                class="text-xs text-gray-400 line-through">249,000đ</span>
                                                        </div>
                                                        <button
                                            ...
                                            <div
                                                class="menu-item group bg-white rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-sm hover:shadow-xl border border-gray-50 transition-all duration-300 flex lg:flex-col gap-4">
                                                <div class="relative shrink-0 w-24 h-24 lg:w-full lg:h-40 rounded-xl lg:rounded-2xl bg-cover bg-center overflow-hidden"
                                                    style="background-image: url('https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=400&h=300&fit=crop');">
                                                    <span
                                                        class="absolute top-2 left-2 bg-green-500 text-white text-[9px] font-black px-2 py-1 rounded-full uppercase tracking-wider shadow-lg">New</span>
                                                </div>
                                                <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                                    <div>
                                                        <h4
                                                            class="text-base lg:text-lg font-bold text-secondary group-hover:text-primary transition-colors line-clamp-1">
                                                            Combo Pizza Party</h4>
                                                        <p class="text-xs lg:text-sm text-gray-400 line-clamp-2 mt-1">
                                                            Pizza size L + 4 Gà rán + Salad + 4 Nước ngọt.</p>
                                                    </div>
                                                    <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                        <div class="flex flex-col">
                                                            <span
                                                                class="text-lg lg:text-xl font-black text-primary">399,000đ</span>
                                                            <span
                                                                class="text-xs text-gray-400 line-through">499,000đ</span>
                                                        </div>
                                                        <button
                                                            class="add-btn size-10 lg:size-12 rounded-xl lg:rounded-2xl bg-secondary text-white flex items-center justify-center shadow-lg group-hover:bg-primary group-hover:scale-110 transition-all active:scale-95">
                                                            <span class="material-symbols-outlined">add</span>
                                            ...
                                            <div
                                                class="menu-item group bg-white rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-sm hover:shadow-xl border border-gray-50 transition-all duration-300 flex lg:flex-col gap-4">
                                                <div class="relative shrink-0 w-24 h-24 lg:w-full lg:h-40 rounded-xl lg:rounded-2xl bg-cover bg-center overflow-hidden"
                                                    style="background-image: url('https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&h=300&fit=crop');">
                                                </div>
                                                <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                                    <div>
                                                        <h4
                                                            ...
                                                            Combo Gia Đình</h4>
                                                        <p class="text-xs lg:text-sm text-gray-400 line-clamp-2 mt-1">
                                                            Set 4 người ăn với thịt nướng, cơm chiên và rau củ.</p>
                                                    </div>
                                                    <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                        <div class="flex flex-col">
                                                            <span
                                                                class="text-lg lg:text-xl font-black text-primary">599,000đ</span>
                                                        </div>
                                                        <button
                                                            class="add-btn size-10 lg:size-12 rounded-xl lg:rounded-2xl bg-secondary text-white flex items-center justify-center shadow-lg group-hover:bg-primary group-hover:scale-110 transition-all active:scale-95">
                                                            <span class="material-symbols-outlined">add</span>
                                    ...
                                    <section id="cat-coffee" class="scroll-mt-nav mb-10">
                                        <div
                                            class="sticky top-28 lg:top-20 z-30 bg-background-light/95 backdrop-blur-sm py-4 -mx-4 px-4 lg:-mx-8 lg:px-8 border-b border-gray-100">
                                            <h2 class="text-xl lg:text-2xl font-black text-secondary tracking-tight">☕
                                                Cà phê</h2>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 mt-4">
                                                ...
                                                <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                                    <div>
                                                        <h4
                                                            class="text-base lg:text-lg font-bold text-secondary group-hover:text-primary transition-colors line-clamp-1">
                                                            Cà phê Sữa đá</h4>
                                                        <p class="text-xs lg:text-sm text-gray-400 line-clamp-2 mt-1">Cà
                                                            phê phin truyền thống pha với sữa đặc thơm ngọt.</p>
                                                    </div>
                                                    <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                        <span
                                                            class="text-lg lg:text-xl font-black text-primary">29,000đ</span>
                                                        <button
                                                            class="add-btn size-10 lg:size-12 rounded-xl lg:rounded-2xl bg-secondary text-white flex items-center justify-center shadow-lg group-hover:bg-primary group-hover:scale-110 transition-all active:scale-95">
                                                            <span class="material-symbols-outlined">add</span>
                                                        </button>
                                            ...
                                            <div
                                                class="menu-item group bg-white rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-sm hover:shadow-xl border border-gray-50 transition-all duration-300 flex lg:flex-col gap-4">
                                                <div class="relative shrink-0 w-24 h-24 lg:w-full lg:h-40 rounded-xl lg:rounded-2xl bg-cover bg-center overflow-hidden"
                                                    style="background-image: url('https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=400&h=300&fit=crop');">
                                                </div>
                                                <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                                    <div>
                                                        <h4
                                                            ...
                                                            Americano</h4>
                                                        <p class="text-xs lg:text-sm text-gray-400 line-clamp-2 mt-1">
                                                            Espresso pha loãng với nước nóng, đậm đà tinh tế.</p>
                                                    </div>
                                                    <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                        <span
                                                            class="text-lg lg:text-xl font-black text-primary">39,000đ</span>
                                                        <button
                                                            class="add-btn size-10 lg:size-12 rounded-xl lg:rounded-2xl bg-secondary text-white flex items-center justify-center shadow-lg group-hover:bg-primary group-hover:scale-110 transition-all active:scale-95">
                                                            <span class="material-symbols-outlined">add</span>
                                                        </button>
                                            ...
                                            <div
                                                class="menu-item group bg-white rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-sm hover:shadow-xl border border-gray-50 transition-all duration-300 flex lg:flex-col gap-4">
                                                <div class="relative shrink-0 w-24 h-24 lg:w-full lg:h-40 rounded-xl lg:rounded-2xl bg-cover bg-center overflow-hidden"
                                                    style="background-image: url('https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=400&h=300&fit=crop');">
                                                </div>
                                                <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                                    <div>
                                                        <h4
                                                            ...
                                                            Cappuccino</h4>
                                                        <p class="text-xs lg:text-sm text-gray-400 line-clamp-2 mt-1">
                                                            Espresso với bọt sữa mịn màng, rắc bột cacao.</p>
                                                    </div>
                                                    <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                        <span
                                                            class="text-lg lg:text-xl font-black text-primary">45,000đ</span>
                                                        <button
                                                            class="add-btn size-10 lg:size-12 rounded-xl lg:rounded-2xl bg-secondary text-white flex items-center justify-center shadow-lg group-hover:bg-primary group-hover:scale-110 transition-all active:scale-95">
                                                            <span class="material-symbols-outlined">add</span>
                                                        </button>
                                    ...
                                    <section id="cat-tea" class="scroll-mt-nav mb-10">
                                        ...
                                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 mt-4">
                                            <div
                                                class="menu-item group bg-white rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-sm hover:shadow-xl border border-gray-50 transition-all duration-300 flex lg:flex-col gap-4">
                                                <div class="relative shrink-0 w-24 h-24 lg:w-full lg:h-40 rounded-xl lg:rounded-2xl bg-cover bg-center overflow-hidden"
                                                    style="background-image: url('https://images.unsplash.com/photo-1558857563-b371033873b8?w=400&h=300&fit=crop');">
                                                    <span
                                                        class="absolute top-2 left-2 bg-red-500 text-white text-[9px] font-black px-2 py-1 rounded-full uppercase tracking-wider shadow-lg">Best
                                                        Seller</span>
                                                </div>
                                                <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                                    <div>
                                                        <h4
                                                            class="text-base lg:text-lg font-bold text-secondary group-hover:text-primary transition-colors line-clamp-1">
                                                            Trà sữa Trân châu đường đen</h4>
                                                        <p class="text-xs lg:text-sm text-gray-400 line-clamp-2 mt-1">
                                                            Trà sữa Đài Loan với trân châu tươi ngâm đường đen.</p>
                                                    </div>
                                                    <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                        <span
                                                            class="text-lg lg:text-xl font-black text-primary">45,000đ</span>
                                            ...
                                            <div
                                                class="menu-item group bg-white rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-sm hover:shadow-xl border border-gray-50 transition-all duration-300 flex lg:flex-col gap-4">
                                                <div class="relative shrink-0 w-24 h-24 lg:w-full lg:h-40 rounded-xl lg:rounded-2xl bg-cover bg-center overflow-hidden"
                                                    style="background-image: url('https://images.unsplash.com/photo-1541167760496-1628856ab772?w=400&h=300&fit=crop');">
                                                </div>
                                                <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                                    <div>
                                                        <h4
                                                            ...
                                                            Trà Đào Cam Sả</h4>
                                                        <p class="text-xs lg:text-sm text-gray-400 line-clamp-2 mt-1">
                                                            Trà hoa quả tươi mát với đào, cam và sả thơm nồng.</p>
                                                    </div>
                                                    <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                        <span
                                                            class="text-lg lg:text-xl font-black text-primary">39,000đ</span>
                                            ...
                                            <!-- Sold Out Example -->
                                            <div
                                                class="menu-item sold-out group bg-white rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-sm border border-gray-50 transition-all duration-300 flex lg:flex-col gap-4">
                                                <div class="relative shrink-0 w-24 h-24 lg:w-full lg:h-40 rounded-xl lg:rounded-2xl bg-cover bg-center overflow-hidden grayscale"
                                                    style="background-image: url('https://images.unsplash.com/photo-1587049352851-8d4e89133924?w=400&h=300&fit=crop');">
                                                    <span
                                                ...
                                                <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                                    <div>
                                                        <h4
                                                            class="text-base lg:text-lg font-bold text-gray-400 line-clamp-1">
                                                            Matcha Latte</h4>
                                                        <p class="text-xs lg:text-sm text-gray-300 line-clamp-2 mt-1">
                                                            Matcha Nhật Bản pha với sữa tươi béo ngậy.</p>
                                                    </div>
                                                    <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                        <span
                                                            class="text-lg lg:text-xl font-black text-gray-400">55,000đ</span>
                                                        <button
                                                            class="notify-btn size-10 lg:size-12 rounded-xl lg:rounded-2xl bg-gray-200 text-gray-500 flex items-center justify-center">
                                                            <span
                                    ...
                                    <section id="cat-food" class="scroll-mt-nav mb-10">
                                        ...
                                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 mt-4">
                                            <div
                                                class="menu-item group bg-white rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-sm hover:shadow-xl border border-gray-50 transition-all duration-300 flex lg:flex-col gap-4">
                                                <div class="relative shrink-0 w-24 h-24 lg:w-full lg:h-40 rounded-xl lg:rounded-2xl bg-cover bg-center overflow-hidden"
                                                    style="background-image: url('https://images.unsplash.com/photo-1550547660-d9450f859349?w=400&h=300&fit=crop');">
                                                </div>
                                                <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                                    <div>
                                                        <h4
                                                            class="text-base lg:text-lg font-bold text-secondary group-hover:text-primary transition-colors line-clamp-1">
                                                            Burger Bò Phô Mai</h4>
                                                        <p class="text-xs lg:text-sm text-gray-400 line-clamp-2 mt-1">
                                                            Burger bò nướng với phô mai cheddar tan chảy.</p>
                                                    </div>
                                                    <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                        <span
                                                            class="text-lg lg:text-xl font-black text-primary">65,000đ</span>
                                                        <button
                                                            class="add-btn size-10 lg:size-12 rounded-xl lg:rounded-2xl bg-secondary text-white flex items-center justify-center shadow-lg group-hover:bg-primary group-hover:scale-110 transition-all active:scale-95">
                                                            <span class="material-symbols-outlined">add</span>
                                                        </button>
                                            ...
                                            <div
                                                class="menu-item group bg-white rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-sm hover:shadow-xl border border-gray-50 transition-all duration-300 flex lg:flex-col gap-4">
                                                <div class="relative shrink-0 w-24 h-24 lg:w-full lg:h-40 rounded-xl lg:rounded-2xl bg-cover bg-center overflow-hidden"
                                                    style="background-image: url('https://images.unsplash.com/photo-1606755962773-d324e0a13086?w=400&h=300&fit=crop');">
                                                </div>
                                                <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                                    <div>
                                                        <h4
                                                            class="text-base lg:text-lg font-bold text-secondary group-hover:text-primary transition-colors line-clamp-1">
                                                            Gà rán giòn</h4>
                                                        <p class="text-xs lg:text-sm text-gray-400 line-clamp-2 mt-1">Gà
                                                            tẩm bột chiên giòn thơm lừng, kèm sốt mật ong.</p>
                                                    </div>
                                                    <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                        <span
                                                            class="text-lg lg:text-xl font-black text-primary">55,000đ</span>
                                                        <button
                                                            class="add-btn size-10 lg:size-12 rounded-xl lg:rounded-2xl bg-secondary text-white flex items-center justify-center shadow-lg group-hover:bg-primary group-hover:scale-110 transition-all active:scale-95">
                                                            <span class="material-symbols-outlined">add</span>
                                                        </button>
                                            ...
                                            <div
                                                class="menu-item group bg-white rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-sm hover:shadow-xl border border-gray-50 transition-all duration-300 flex lg:flex-col gap-4">
                                                <div class="relative shrink-0 w-24 h-24 lg:w-full lg:h-40 rounded-xl lg:rounded-2xl bg-cover bg-center overflow-hidden"
                                                    style="background-image: url('https://images.unsplash.com/photo-1630384060421-cb20aed52c83?w=400&h=300&fit=crop');">
                                                </div>
                                                <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                                    <div>
                                                        <h4
                                                            ...
                                                            Khoai tây chiên</h4>
                                                        <p class="text-xs lg:text-sm text-gray-400 line-clamp-2 mt-1">
                                                            Khoai tây chiên giòn vàng đều, kèm sốt tương ớt.</p>
                                                    </div>
                                                    <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                        <span
                                                            class="text-lg lg:text-xl font-black text-primary">35,000đ</span>
                                                        <button
                                                            class="add-btn size-10 lg:size-12 rounded-xl lg:rounded-2xl bg-secondary text-white flex items-center justify-center shadow-lg group-hover:bg-primary group-hover:scale-110 transition-all active:scale-95">
                                                            <span class="material-symbols-outlined">add</span>
                                                        </button>
                                    ...
                                    <section id="cat-dessert" class="scroll-mt-nav mb-10">
                                        ...
                                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 mt-4">
                                            <div
                                                class="menu-item group bg-white rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-sm hover:shadow-xl border border-gray-50 transition-all duration-300 flex lg:flex-col gap-4">
                                                <div class="relative shrink-0 w-24 h-24 lg:w-full lg:h-40 rounded-xl lg:rounded-2xl bg-cover bg-center overflow-hidden"
                                                    style="background-image: url('https://images.unsplash.com/photo-1551024601-bec78aea704b?w=400&h=300&fit=crop');">
                                                    <span
                                                        class="absolute top-2 left-2 bg-green-500 text-white text-[9px] font-black px-2 py-1 rounded-full uppercase tracking-wider shadow-lg">New</span>
                                                </div>
                                                <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                                    <div>
                                                        <h4
                                                            ...
                                                            Tiramisu</h4>
                                                        <p class="text-xs lg:text-sm text-gray-400 line-clamp-2 mt-1">
                                                            Bánh Tiramisu Ý với kem mascarpone và cà phê espresso.</p>
                                                    </div>
                                                    <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                        <span
                                                            class="text-lg lg:text-xl font-black text-primary">69,000đ</span>
                                                        <button
                                                            class="add-btn size-10 lg:size-12 rounded-xl lg:rounded-2xl bg-secondary text-white flex items-center justify-center shadow-lg group-hover:bg-primary group-hover:scale-110 transition-all active:scale-95">
                                                            <span class="material-symbols-outlined">add</span>
                                                        </button>
                                            ...
                                            <div
                                                class="menu-item group bg-white rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-sm hover:shadow-xl border border-gray-50 transition-all duration-300 flex lg:flex-col gap-4">
                                                <div class="relative shrink-0 w-24 h-24 lg:w-full lg:h-40 rounded-xl lg:rounded-2xl bg-cover bg-center overflow-hidden"
                                                    style="background-image: url('https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=400&h=300&fit=crop');">
                                                </div>
                                                <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                                    <div>
                                                        <h4
                                                            ...
                                                            Kem Gelato</h4>
                                                        <p class="text-xs lg:text-sm text-gray-400 line-clamp-2 mt-1">
                                                            Kem Ý gelato với nhiều vị: Vani, Chocolate, Dâu.</p>
                                                    </div>
                                                    <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                        <span
                                                            class="text-lg lg:text-xl font-black text-primary">45,000đ</span>
                            ...
                            <button
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="text-left">
                                        ...
                                        <p class="text-xs text-white/70"><span id="floatingCartCount">0</span> món</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex flex-col lg:flex-row h-full max-h-[90vh] lg:max-h-[85vh]">
                                        ...
                                        <div class="flex-1 flex flex-col overflow-hidden lg:w-[55%]">
                                            ...
                                            <div class="flex-1 overflow-y-auto p-5 lg:p-6 pb-32 lg:pb-6">
                                                ...
                                                <div class="mb-6">
                                                    <h1 id="modalTitle"
                                                        class="text-xl lg:text-2xl font-black text-secondary">Trà sữa
                                                        Trân
                                                        châu đường đen</h1>
                                                    ...
                                                    <p class="mt-3"><span id="modalBasePrice"
                                                            class="text-2xl font-black text-primary">45,000đ</span></p>
                                                </div>
                                                ...
                                                <div class="option-group mb-6" data-required="true">
                                                    ...
                                                    <div class="flex gap-3">
                                                        ...
                                                        <label class="size-option flex-1 cursor-pointer">
                                                            <input type="radio" name="size" value="5000" data-label="M"
                                                                class="hidden">
                                                            <div
                                                                ...
                                                                M <span class="text-xs text-gray-400">+5k</span></div>
                                                        </label>
                                                        <label class="size-option flex-1 cursor-pointer">
                                                            <input type="radio" name="size" value="10000" data-label="L"
                                                                class="hidden">
                                                            <div
                                                                class="border-2 border-gray-200 hover:border-primary/50 rounded-xl py-3 text-center font-bold text-gray-600 transition-all">
                                                                L <span class="text-xs text-gray-400">+10k</span></div>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="option-group mb-6" data-required="true">
                                                    ...
                                                    <div class="grid grid-cols-4 gap-2">
                                                        <label class="sugar-option cursor-pointer">
                                                            <input type="radio" name="sugar" value="0%" class="hidden">
                                                            <div
                                                        ...
                                                        <label class="sugar-option cursor-pointer">
                                                            <input type="radio" name="sugar" value="30%" class="hidden">
                                                            <div
                                                                class="border-2 border-gray-200 hover:border-primary/50 rounded-xl py-2.5 text-center text-sm font-medium text-gray-600 transition-all">
                                                                30%</div>
                                                        </label>
                                                        <label class="sugar-option cursor-pointer">
                                                            <input type="radio" name="sugar" value="50%" class="hidden">
                                                            <div
                                                                class="border-2 border-gray-200 hover:border-primary/50 rounded-xl py-2.5 text-center text-sm font-medium text-gray-600 transition-all">
                                                                50%</div>
                                                        </label>
                                                        <label class="sugar-option cursor-pointer">
                                                            <input type="radio" name="sugar" value="100%" class="hidden"
                                                                checked>
                                                            <div
                                                ...
                                                <div class="option-group mb-6" data-required="true">
                                                    ...
                                                    <div class="grid grid-cols-4 gap-2">
                                                        ...
                                                        <label class="ice-option cursor-pointer">
                                                            <input type="radio" name="ice" value="Ít đá" class="hidden">
                                                            <div
                                                                class="border-2 border-gray-200 hover:border-primary/50 rounded-xl py-2.5 text-center text-sm font-medium text-gray-600 transition-all">
                                                                Ít</div>
                                                        </label>
                                                ...
                                                <div class="option-group mb-6">
                                                    ...
                                                    <div class="space-y-2">
                                                        <label
                                                            ...
                                                            <span class="text-sm font-bold text-primary">+5,000đ</span>
                                                        </label>
                                                        <label
                                                            ...
                                                            <span class="text-sm font-bold text-primary">+8,000đ</span>
                                                        </label>
                                                        <label
                                                            class="topping-option flex items-center justify-between p-3 border-2 border-gray-100 hover:border-primary/30 rounded-xl cursor-pointer transition-all">
                                                            <div class="flex items-center gap-3">
                                                            ...
                                                            <span class="text-sm font-bold text-primary">+10,000đ</span>
                                                        </label>
                                                        <label
                                                            class="topping-option flex items-center justify-between p-3 border-2 border-gray-100 hover:border-primary/30 rounded-xl cursor-pointer transition-all">
                                                            <div class="flex items-center gap-3">
                    ...
                    <script>
                        ...
                        document.querySelectorAll('.add-btn').forEach(btn => {
                            btn.addEventListener('click', (e) => {
                                ...
                                cart.push({ name, quantity: 1, unitPrice: price, totalPrice: price });
                                cartCount++;
                                cartTotal += price;
                                updateCartUI();
                                showToast();
