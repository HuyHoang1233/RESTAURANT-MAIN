    ...
    <body class="bg-background-light font-sans text-secondary">
        ...
        <div class="min-h-screen flex flex-col">
            ...
            <main class="flex-1 pt-28 lg:pt-24">
                <div class="max-w-7xl mx-auto flex">
                    ...
                    <aside class="hidden lg:block w-64 shrink-0 sticky top-24 h-[calc(100vh-6rem)] overflow-y-auto no-scrollbar border-r border-gray-100 bg-white p-6">
                    ...
                    <div class="flex-1 px-4 lg:px-8 pb-32 lg:pb-20">
                        ...
                        <section id="cat-combo" class="scroll-mt-nav mb-10">
                            <div class="sticky top-28 lg:top-20 z-30 bg-background-light/95 backdrop-blur-sm py-4 -mx-4 px-4 lg:-mx-8 lg:px-8 border-b border-gray-100">
                                <h2 class="text-xl lg:text-2xl font-black text-secondary tracking-tight flex items-center gap-2">
                                    🔥 Combo Tiết Kiệm
                                    <span class="text-xs font-bold text-white bg-red-500 px-2 py-0.5 rounded-full uppercase">Hot</span>
                                </h2>
                            </div>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 mt-4">
                                <c:forEach items="${comboList}" var="p">
                                    <div class="menu-item group bg-white rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-sm hover:shadow-xl border border-gray-50 transition-all duration-300 flex lg:flex-col gap-4 ${!p.available ? 'sold-out' : ''}">
                                        <!-- Image -->
                                     ...
                                     style="background-image: url('${p.imageUrl}');">
                                            <c:if test="${!p.available}">
                                                <span class="absolute top-2 left-2 bg-gray-500 text-white text-[9px] font-black px-2 py-1 rounded-full uppercase tracking-wider shadow-lg">
                                                    Hết hàng</span>
                                                </c:if>
                                        </div>
                                        <!-- Info -->
                                        <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                            <div>
                                                <h4 class="text-base lg:text-lg font-bold text-secondary group-hover:text-primary transition-colors line-clamp-1">
                                                    ${p.name}</h4>
                                            ...
                                            <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                <div class="flex flex-col">
                                                    <span class="text-lg lg:text-xl font-black ${!p.available ? 'text-gray-400' : 'text-primary'}">
                                                        <fmt:formatNumber value="${p.price}"
                                                                          type="number" pattern="#,###" />đ
                                                    </span>
                                                </div>
                                                <button class="add-btn size-10 lg:size-12 rounded-xl lg:rounded-2xl bg-secondary text-white flex items-center justify-center shadow-lg group-hover:bg-primary group-hover:scale-110 transition-all active:scale-95">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 mt-4">
                                <c:forEach items="${coffeeList}" var="p">
                                    <div class="menu-item group bg-white rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-sm hover:shadow-xl border border-gray-50 transition-all duration-300 flex lg:flex-col gap-4 ${!p.available ? 'sold-out' : ''}">
                                     ...
                                     style="background-image: url('${p.imageUrl}');">
                                            <c:if test="${!p.available}">
                                                <span class="absolute top-2 left-2 bg-gray-500 text-white text-[9px] font-black px-2 py-1 rounded-full uppercase tracking-wider shadow-lg">Hết
                                                    hàng</span>
                                                </c:if>
                                        </div>
                                        <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                     ...
                                     style="background-image: url('${p.imageUrl}');">
                                        ...
                                        <div class="flex-1 flex flex-col justify-between lg:gap-3">
                                            ...
                                            <div class="flex items-center justify-between mt-2 lg:mt-0">
                                                ...
                                                <button class="${!p.available ? 'notify-btn bg-gray-200 text-gray-500' : 'add-btn bg-secondary text-white group-hover:bg-primary'} size-10 lg:size-12 rounded-xl lg:rounded-2xl flex items-center justify-center shadow-lg transition-all active:scale-95">
                                                    <span class="material-symbols-outlined">${!p.available
            ...
            <div id="toast" class="fixed bottom-24 left-1/2 -translate-x-1/2 z-50 hidden">
                <div class="toast bg-secondary text-white px-6 py-3 rounded-full shadow-2xl flex items-center gap-2">
            ...
            <div id="productModal" class="fixed inset-0 z-[60] hidden">
                ...
                <div class="absolute inset-0 lg:flex lg:items-center lg:justify-center lg:p-8 pointer-events-none">
                    <!-- Modal Panel -->
                    <div id="modalPanel"
                     class="pointer-events-auto absolute bottom-0 left-0 right-0 lg:relative lg:bottom-auto lg:left-auto lg:right-auto lg:max-w-[900px] lg:w-full bg-white rounded-t-3xl lg:rounded-3xl max-h-[90vh] lg:max-h-[85vh] overflow-hidden shadow-2xl transform translate-y-full lg:translate-y-0 lg:scale-95 lg:opacity-0 transition-all duration-300">
                        ...
                        <div class="flex flex-col lg:flex-row h-full max-h-[90vh] lg:max-h-[85vh]">
                            ...
                            <div class="flex-1 flex flex-col overflow-hidden lg:w-[55%]">
                                ...
                                <div class="flex-1 overflow-y-auto p-5 lg:p-6 pb-32 lg:pb-6">
                                    ...
                                    <div class="mb-6">
                                        <h1 id="modalTitle"
                                    class="text-xl lg:text-2xl font-black text-secondary">
                                            Trà sữa trân châu đường đen</h1>
                                        <p id="modalDesc" class="text-sm text-gray-500 mt-2">
                                            Trà sữa Đài Loan với trân châu tươi ngâm đường đen thơm ngon.</p>
                                   ...
                                   class="text-2xl font-black text-primary">45,000đ</span>
                                    ...
                                    <div class="option-group mb-6" data-required="true">
                                        <h3 class="text-[11px] font-black uppercase tracking-widest text-gray-400 mb-3">
                                        ...
                                        <div class="flex gap-3">
                                            <label class="size-option flex-1 cursor-pointer">
                                             ...
                                             class="hidden" checked>
                                                <div class="border-2 border-primary bg-primary/10 rounded-xl py-3 text-center font-bold text-primary transition-all">
                                                    S</div>
                                            </label>
                                            <label class="size-option flex-1 cursor-pointer">
                                                <input type="radio" name="size" value="5000"
                                                       data-label="M" class="hidden">
                                                <div class="border-2 border-gray-200 hover:border-primary/50 rounded-xl py-3 text-center font-bold text-gray-600 transition-all">
                                        ...
                                        <div class="grid grid-cols-4 gap-2">
                                            <label class="sugar-option cursor-pointer">
                                                <input type="radio" name="sugar" value="0%"
                                                       class="hidden">
                                                <div class="border-2 border-gray-200 hover:border-primary/50 rounded-xl py-2.5 text-center text-sm font-medium text-gray-600 transition-all">
                                                    0%</div>
                                            </label>
                                            <label class="sugar-option cursor-pointer">
                                            ...
                                            <label class="sugar-option cursor-pointer">
                                                <input type="radio" name="sugar" value="100%"
                                                       class="hidden" checked>
                                                <div class="border-2 border-primary bg-primary/10 rounded-xl py-2.5 text-center text-sm font-bold text-primary transition-all">
                                                    100%</div>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="option-group mb-6">
                                        <h3 class="text-[11px] font-black uppercase tracking-widest text-gray-400 mb-3">
                                            Topping</h3>
                                        <div class="space-y-2">
                                            <label class="topping-option flex items-center justify-between p-3 border-2 border-gray-100 hover:border-primary/30 rounded-xl cursor-pointer transition-all">
                                                <div class="flex items-center gap-3">
                                            ...
                                            <label class="topping-option flex items-center justify-between p-3 border-2 border-gray-100 hover:border-primary/30 rounded-xl cursor-pointer transition-all relative">
                                                <div class="flex items-center gap-3">
                                                    <input type="checkbox" name="topping" value="8000"
                                                           data-name="Trân châu trắng"
                                                           class="size-5 accent-primary rounded">
                                                    <span class="font-medium">Trân châu trắng</span>
                                                    <span class="text-[9px] font-black bg-amber-400 text-amber-900 px-1.5 py-0.5 rounded-full">⭐
                                                        BEST</span>
                                                </div>
                                ...
                                <div class="hidden lg:flex items-center justify-between p-5 border-t border-gray-100 bg-white">
                        ...
                        <div class="lg:hidden absolute bottom-0 left-0 right-0 flex items-center justify-between p-4 border-t border-gray-100 bg-white shadow-[0_-4px_20px_rgba(0,0,0,0.08)]">
                            <div class="flex items-center gap-1 bg-gray-100 rounded-xl p-1">
                                <button id="qtyMinus"
                                 class="size-11 rounded-xl hover:bg-white flex items-center justify-center font-bold text-xl text-gray-500 transition-colors">−</button>
        ...
        <script>
            ...
            menuItems.forEach(item => {
                item.addEventListener('click', (e) => {
                    if (e.target.closest('.add-btn'))
                        return; // Ignore if clicking add button
            ...
            function syncCartWithServer(item) {
                ...
                if (item.sugar)
                    desc += ` • ${item.sugar} Đường`;
                if (item.ice)
                    desc += ` • ${item.ice} Đá`;
                if (item.toppings && item.toppings.length > 0)
                    desc += ` • Thêm: ${item.toppings.join(', ')}`;
                if (item.note)
                    desc += ` • Ghi chú: ${item.note}`;
